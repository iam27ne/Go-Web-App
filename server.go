...
import (
	"gowebappwithginhhyva/routers"
	"gowebappwithginhhyva/plugins"
...
func main() {
	...
	collector := plugins.InitializePrometheusCollector(plugins.PrometheusCollectorConfig{
		Namespace: "gowebappwithginhhyva",
	})
	...
	// tracer, closer := jaeger.NewTracer("gowebappwithginhhyva",
	// 	sampler,
	// 	reporter,
	...
	log.Info("Starting GoWebAppwithGinHHYVA on port " + port())
